...
def _get_verification_status_icon(verification_status: VerificationStatus) -> str:
    table = {
        ...
        VerificationStatus.TEST_IGNORED: ":grey_question:",
    }
...
def _render_source_code_stat_for_page(
    ...
    *,
    ...
    data["_verificationStatusIcon"] = _get_verification_status_icon(
...
def load_static_files(
    *, site_render_config: SiteRenderConfig
    ...
    for path in _COPIED_STATIC_FILE_PATHS:
        files[site_render_config.destination_dir / pathlib.Path(path)] = (
